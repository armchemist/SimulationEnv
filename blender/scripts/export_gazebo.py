...
MODELS = [
    dict(name="waste_bucket", objects=["Waste_Bucket"],
         origin=(-0.5735, 0.320, 0.0), mass=0.45,
    ...
    dict(name="reagent_bottle_h2o2", objects=["Chemical_Bottle_H2O2"],
         origin=(0.3355, 0.295, 0.0), mass=0.55,
    ...
    dict(name="reagent_bottle_acid", objects=["Chemical_Bottle_ACID"],
         origin=(0.5455, 0.365, 0.0), mass=0.60,
    ...
    dict(name="reagent_bottle_naoh", objects=["Chemical_Bottle_NAOH"],
         origin=(0.6155, 0.295, 0.0), mass=0.60,
         shape=("box", 0.073, 0.056, 0.187), centre=(0, 0, 0.0935),
    ...
    dict(name="omx_module", objects=["OMX_Module_Left"],
         origin=(-0.116527, 0.074456, 0.0), mass=1.5, static=True,
         decimate=0.016,
         shape=("box", 0.150, 0.375, 0.277), centre=(0, 0.075, 0.214),
         desc="OpenMANIPULATOR-X visual placeholder (decimated, non-articulated)"),
]

# world placement: model name -> list of (instance name, x, y, z)
WORLD_POSES = [
    ("waste_bucket",           "waste_bucket",           -0.5735,  0.320, 0.0),
    ("beaker",                 "beaker_01",              -0.364,   0.330, 0.0),
    ("beaker",                 "beaker_02",              -0.274,   0.330, 0.0),
    ("cylinder_holder",        "cylinder_holder_01",     -0.0605,  0.330, 0.0),
    ("cylinder_holder",        "cylinder_holder_02",      0.1195,  0.330, 0.0),
    ("reagent_bottle_h2o2",    "reagent_bottle_h2o2",     0.3355,  0.295, 0.0),
    ("reagent_bottle_ethanol", "reagent_bottle_ethanol",  0.4055,  0.365, 0.0),
    ("reagent_bottle_solvent", "reagent_bottle_solvent",  0.4755,  0.295, 0.0),
    ("reagent_bottle_acid",    "reagent_bottle_acid",     0.5455,  0.365, 0.0),
    ("reagent_bottle_naoh",    "reagent_bottle_naoh",     0.6155,  0.295, 0.0),
...
def write_world():
    includes = []
    for model, inst, x, y, z in WORLD_POSES:
        includes.append(
            "    <include>\n"
...
<!-- Lab bench world, generated by blender/scripts/export_gazebo.py -->
<sdf version="1.10">
  <world name="lab_bench">
...
"""
    ...
    with open(os.path.join(WORLDS_DIR, "lab_bench.world"), "w", encoding="utf-8") as f:
        f.write(world)
...
def main():
    ...
    write_rail_axis()
    write_world()
    print("done - %d models, %d triangles" % (len(MODELS), total))
